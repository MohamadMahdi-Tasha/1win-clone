...
export default function DownloadHoverDropdownComponent({position = 'bottom'}:propsType):ReactNode {
    // Returning JSX
    return (
        <div data-position={position} className={'absolute z-[100] data-[position="top"]:bottom-[120%] data-[position="bottom"]:top-[150%] left-[50%] -translate-x-[50%] bg-white rounded-[10px] w-[300px] shadow-lg opacity-0 group-hover:opacity-100 group-hover:visible transition-all duration-500 data-[position="bottom"]:before-triangle invisible'}>
