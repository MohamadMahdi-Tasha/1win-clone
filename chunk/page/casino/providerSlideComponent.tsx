                    ...
                    (images.length === 1)
                        ? (
                            [...new Array(6)].map((item, index) => (
                                <img key={index} className={'rounded-[10px] w-full'} src={images[0]} alt="Image of recent games" />
                            ))
                        ) : (
                            images.map((image, index) => (
                                <img key={index} className={'rounded-[10px] w-full'} src={image} alt="Image of recent games" />
                            ))
                        )
                }
            </div>
