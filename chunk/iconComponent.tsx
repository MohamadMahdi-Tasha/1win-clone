...
interface propsType {
    name: 'lock' | 'mobile' | 'arrow-right' | 'star-bag' | 'windows' | 'android' | 'apple' | 'chevron' | 'tick' | 'plus' | 'list' | 'search' | 'person' | 'x' | 'chat' | 'telegram' | 'info' | 'instagram' | 'facebook' | 'twitter-x' | 'top';
    size: number;
}
